...
export default function About() {
  return (
    ...
    <div className='max-w-2xl mx-auto p-3 text-center'>
      <div>
        <h1 className='text-3xl font-semibold text-center my-7'>About Ankur's Blog</h1>
        <div className='text-md text-gray-500 flex flex-col gap-6'>
          <p>
            Ankur's Blog is a blog that I created to share my thoughts and ideas with the world.I am a student at IIITBH and I love to share my experience and thoughts about different topics that I have learned.
